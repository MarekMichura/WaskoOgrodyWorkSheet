...
public class StorageDayOffDate {
  ...
  public readonly static ModelDayOffDate[] DaysOff =
    [DayOff1, DayOff2, DayOff3, DayOff4, DayOff5];

  public readonly static string dayOffDima = DayOff1.ID;
  public readonly static string dayOffLoszka = DayOff2.ID;
  public readonly static string dayOffEryk1 = DayOff3.ID;
  public readonly static string dayOffEryk2 = DayOff4.ID;
  public readonly static string dayOffAuthor = DayOff5.ID;
}
#endif