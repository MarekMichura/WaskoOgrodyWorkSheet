...
public static class TokenGetUsersWorkHour {
  ...
  public static void AddExpirationGetUsersWorkHour(this ICacheEntry cache, string userID, DateOnly from, DateOnly to)
  {
