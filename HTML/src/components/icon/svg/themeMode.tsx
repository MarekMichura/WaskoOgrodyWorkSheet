'use client'
import {useTheme} from '@/utils/query/themeUse'
import {DARK_THEME} from '@/utils/type/common/iTheme'
...
function ThemeModeIcon(props: IIconProps) {
  const {theme} = useTheme()

  return (
    <Icon {...props}>
      <path d={theme === DARK_THEME ? dark : light} />
    </Icon>
  )
}
